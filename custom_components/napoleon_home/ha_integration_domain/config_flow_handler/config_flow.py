...
from custom_components.napoleon_home.config_flow_handler.schemas import (
    get_reauth_schema,
    get_reconfigure_schema,
    get_user_schema,
)
from custom_components.napoleon_home.config_flow_handler.validators import validate_credentials
from custom_components.napoleon_home.const import DOMAIN, LOGGER
...
ERROR_MAP = {
    "NapoleonHomeApiClientAuthenticationError": "auth",
    "NapoleonHomeApiClientCommunicationError": "connection",
}
