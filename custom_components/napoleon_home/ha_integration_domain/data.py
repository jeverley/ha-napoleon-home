"""
Custom types for napoleon_home.
...
The NapoleonHomeConfigEntry type alias is used throughout the integration
...
if TYPE_CHECKING:
    ...
    from .api import NapoleonHomeApiClient
    from .coordinator import NapoleonHomeDataUpdateCoordinator


type NapoleonHomeConfigEntry = ConfigEntry[NapoleonHomeData]


@dataclass
class NapoleonHomeData:
    """Runtime data for napoleon_home config entries.
