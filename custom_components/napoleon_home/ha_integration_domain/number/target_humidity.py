"""Target humidity number for napoleon_home."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.napoleon_home.api import NapoleonHomeApiClientError
...
class NapoleonHomeHumidityNumber(NumberEntity, NapoleonHomeEntity):
