"""
Core DataUpdateCoordinator implementation for napoleon_home.
...
class NapoleonHomeDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    async def _async_update_data(self) -> Any:
        ...
        except NapoleonHomeApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="napoleon_home",
                translation_key="authentication_failed",
            ) from exception
        except NapoleonHomeApiClientError as exception:
