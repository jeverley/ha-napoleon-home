...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        NapoleonHomeApiClientAuthenticationError: For 401/403 errors.
...
class NapoleonHomeApiClient:
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            NapoleonHomeApiClientAuthenticationError: If authentication fails.
            NapoleonHomeApiClientCommunicationError: If communication fails.
            NapoleonHomeApiClientError: For other API errors.
