...
│   ├── __init__.py          # Exports NapoleonHomeDataUpdateCoordinator
...
│   ├── __init__.py          # Exports NapoleonHomeEntity
...
- `base.py` - Main coordinator class (`NapoleonHomeDataUpdateCoordinator`)
...
**Key class:** `NapoleonHomeApiClient`
...
- `NapoleonHomeConfigFlowHandler` (main flow)
- `NapoleonHomeOptionsFlow` (options)
