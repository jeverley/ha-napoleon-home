...
from .connectivity import ENTITY_DESCRIPTIONS as CONNECTIVITY_DESCRIPTIONS, NapoleonHomeConnectivitySensor
from .filter import ENTITY_DESCRIPTIONS as FILTER_DESCRIPTIONS, NapoleonHomeFilterSensor
...
async def async_setup_entry(
    ...
    connectivity_entities = [
        NapoleonHomeConnectivitySensor(
